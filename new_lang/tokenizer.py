...
class Tokenize:
    ...
    empty pointer:null
    """
    grammer = r'@|\bfunc\b|\bclass\b|\battr\b|\bhook\b|\bstr\b|\bbool\b|\bint\b|\bfloat\b|\bcallable\b|\bobject\b|\bnull\b|\bTrue\b|\bFalse\b|\bswitch\b|\bcase\b|\bif\b|\belif\b|\belse\b|\bwhile\b|\bfor\b|\bin\b|\-\>|\+\+|\-\-|[\*\-\+]{1}\=|\=\=|\<\=|\>\=|\=|\<|\>|\+|\-|\*|/|:|\(|\)|\[|\]|\{|\}|\.|^\s+|,|"[\w\W]+"|\d+\.\d+|\d+|\w+'
    token_list = [['at', 'denote', r'@'], ['identifier', 'func', r'\bfunc\b'], ['identifier', 'class', r'\bclass\b'], ['identifier', 'attr', r'\battr\b'], ['identifier', 'hook', r'\bhook\b'], ['lang_type', 'str', r'\bstr\b'], ['lang_type', 'bool', r'\bbool\b'], ['lang_type', 'int', r'\bint\b'], ['lang_type', 'float', r'\bfloat\b'], ['lang_type', 'callable', r'\bcallable\b'], ['lang_type', 'object', r'\bobject\b'], ['pointer', 'null', r'\bnull\b'], ['boolean', 'True', r'\bTrue\b'], ['boolean', 'False', r'\bFalse\b'], ['boolean', 'False', r'\bFalse\b'], ['control', 'switch', r'\bswitch\b'], ['control', 'case', r'\bcase\b'], ['control', 'if', r'\bif\b'], ['control', 'elif', r'\belif\b'], ['control', 'else', r'\belse\b'], ['repetitive', 'while', r'\bwhile\b'], ['repetitive', 'for', r'\bfor\b'], ['loop_control', 'in', r'\bin\b'], ['operation', 'arrow', r'\b\-\>\b'], ['operation', 'increment', r'\b\+\+\b'], ['operation', 'decrement', r'\b\-\-\b'], ['operation', 'inplace', r'[\*\-\+]{1}\='], ['operation', 'equals', r'\=\='], ['operation', 'le', r'\<\='], ['operation', 'ge', r'\>\='], ['operation', 'assign', r'\='], ['operation', 'lt', r'\<'], ['operation', 'gt', r'\>'], ['operation', 'add', r'\+'], ['operation', 'sub', r'\-'], ['operation', 'mul', r'\*'], ['operation', 'div', r'/'], ['operation', 'colon', r':'], ['brace', 'lparen', r'\('], ['brace', 'rparen', r'\)'], ['brace', 'lsqure', r'\['], ['brace', 'rsquare', r'\]'], ['brace', 'lcurly', r'\{'], ['brace', 'rcurly', r'\}'], ['operation', 'dot', r'\.'], ['whitespace', 'space', r'^\s+'], ['comma', 'comma', r','], ['value', 'string', r'"[\w\W]+"'], ['value', 'float', r'\d+\.\d+'], ['value', 'integer', r'\d+'], ['name', 'variable', '\w+']]
    @classmethod
